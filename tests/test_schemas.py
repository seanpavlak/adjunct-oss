...
class TestWeekConfig:
    ...
    def test_valid_week_config(self):
        ...
        data = {"topic_id": "12345", "discussion_prompt": "Test prompt", "discussion_data": []}
...
class TestCourseSchema:
    ...
    def test_valid_course(self):
        ...
        data = {
            ...
            "name": "Test Course",
            "weeks": {
                "1": {"topic_id": "67890", "discussion_prompt": "Test", "discussion_data": []}
            },
        }
...
class TestAnnouncementSchema:
    ...
    def test_valid_announcement(self):
        ...
        data = {"week": 1, "title": "Week 1 Announcement", "content": "<p>Test content</p>"}
    ...
    def test_week_out_of_range(self):
        ...
        data = {"week": 9, "title": "Test", "content": "Test"}  # Out of range
        with pytest.raises(ValidationError):
...
class TestCoursesConfig:
    ...
    def test_valid_courses_config(self):
        ...
        data = {
            "courses": {"A": {"course_id": "12345", "course_start_date": "2025-09-02", "weeks": {}}}
        }
